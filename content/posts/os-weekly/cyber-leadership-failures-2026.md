...
![Security Leadership Funnel](/posts/os-weekly/images/security_leadership_funnel.png)
...
Cyber folks and builders: I’ve been moving my automations to [Make](https://www.make.com/en/register?pc=trilltayo) — a visual way to stitch APIs, webhooks, and cron-like schedules without another brittle script. Think flowchart, but it runs.
...
![The Leadership Gap in Security](/posts/os-weekly/images/security_leadership_comparison.png)
